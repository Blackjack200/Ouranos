...
public class ForgeryUtils {
    ...
    public static String forgeAuthData(KeyPair pair, Map<String, Object> extraData) {
    ...
    public static String forgeSkinData(KeyPair pair, int outputProtocol, Map<String, Object> clientData) {
        String publicKeyBase64 = Base64.getEncoder().encodeToString(pair.getPublic().getEncoded());
